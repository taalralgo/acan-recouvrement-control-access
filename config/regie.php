...
return [
    ...
    */
    ...
    'email_domain' => env('REGIE_EMAIL_DOMAIN', 'acan.email'),
    ...
    */
    ...
    'http' => [
        ...
        'timeout' => (int) env('REGIE_HTTP_TIMEOUT', 10),
        'connect_timeout' => (int) env('REGIE_HTTP_CONNECT_TIMEOUT', 5),
    ],
    ...
    'stale_after_minutes' => (int) env('REGIE_STALE_AFTER_MINUTES', 60),
